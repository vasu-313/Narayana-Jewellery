...
const EarringsSingle = () => {
    ...
    const product = earringsData.find(item => 
    ...
    if (!product) {
        ...
        console.log('Available IDs:', earringsData.map(item => item.id))
  ...
  return (    
    ...
    <div className="ind-page">
        ...
        <div className="single-heart">
          <i 
          onClick={() => toggleWishlistItem({...product, category: 'earrings'})}
