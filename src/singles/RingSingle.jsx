...
import { ringData } from '../jewellery/data/ring'
...
const RingSingle = () => {
    ...
    const product = ringData.find(item => 
    ...
    if (!product) {
        ...
        console.log('Available IDs:', ringData.map(item => item.id))
  ...
  return (    
    ...
    <div className="ind-page">
        ...
        <div className="single-heart">
          <i 
          onClick={() => toggleWishlistItem({...product, category: 'ring'})}
