...
import { neckData } from '../jewellery/data/neck'
...
const NecklaceSingle = () => {
    ...
    const product = neckData.find(item => 
    ...
    if (!product) {
        ...
        console.log('Available IDs:', neckData.map(item => item.id))
  ...
  return (    
    ...
    <div className="ind-page">
        ...
        <div className="single-heart">
          <i 
          onClick={() => toggleWishlistItem({...product, category: 'necklace'})}
