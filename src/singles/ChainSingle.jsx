...
import { chainData } from '../jewellery/data/chain'
...
const ChainSingle = () => {
    ...
    const product = chainData.find(item => 
    ...
    if (!product) {
        ...
        console.log('Available IDs:', chainData.map(item => item.id))
  ...
  return (    
    ...
    <div className="ind-page">
        ...
        <div className="single-heart">
          <i 
          onClick={() => toggleWishlistItem({...product, category: 'chains'})}
