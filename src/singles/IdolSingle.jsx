...
import { idolData } from '../jewellery/data/idol'
...
const IdolSingle = () => {
    ...
    const product = idolData.find(item => 
    ...
    if (!product) {
        ...
        console.log('Available IDs:', idolData.map(item => item.id))
  ...
  return (    
    ...
    <div className="ind-page">
        ...
        <div className="single-heart">
          <i 
          onClick={() => toggleWishlistItem({...product, category: 'idol'})}
